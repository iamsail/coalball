...
$.ajax({
    ...
    success: function success(data) {
        ...
        for (var i = 0; i < 5; i++) {
            ...
            if (message[i].path0) {
                $('.img2').eq(_num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + message[i].path0 + message[i].savename0);
            } else {
                $('.img2').eq(_num).css('display', 'none');
            }

            if (message[i].path1) {
                $('.img1').eq(_num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + message[i].path1 + message[i].savename1);
            } else {
    ...
    return function () {
        ...
        if ($('section:last').offset().top < seeHeight + scrollTop && down) {
            ...
            if (need == 0 && off2) {
                ...
                if (message[i].path0) {
                    $('.img2').eq(num1).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + message[i].path0 + message[i].savename0);
                } else {
                    $('.img2').eq(num1).css('display', 'none');
                }

                if (message[i].path1) {
                    $('.img1').eq(num1).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + message[i].path1 + message[i].savename1);
                } else {
            ...
            if (need == 1 && off3) {
                ...
                if (jsonStudy[i].path0) {
                    $('.img2').eq(num2).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonStudy[i].path0 + jsonStudy[i].savename0);
                } else {
                    $('.img2').eq(num2).css('display', 'none');
                }

                if (jsonStudy[i].path1) {
                    $('.img1').eq(num2).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonStudy[i].path1 + jsonStudy[i].savename1);
                } else {
            ...
            if (need == 2 && off4) {
                ...
                if (jsonGroup[i].path0) {
                    $('.img2').eq(num3).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonGroup[i].path0 + jsonGroup[i].savename0);
                } else {
                    $('.img2').eq(num3).css('display', 'none');
                }

                if (jsonGroup[i].path1) {
                    $('.img1').eq(num3).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonGroup[i].path1 + jsonGroup[i].savename1);
                } else {
            ...
            if (need == 3 && off5) {
                ...
                if (jsonDevelop[i].path0) {
                    $('.img2').eq(num4).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonDevelop[i].path0 + jsonDevelop[i].savename0);
                } else {
                    $('.img2').eq(num4).css('display', 'none');
                }

                if (jsonDevelop[i].path1) {
                    $('.img1').eq(num4).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonDevelop[i].path1 + jsonDevelop[i].savename1);
                } else {
            ...
            if (need == 4 && off6) {
                ...
                if (jsonEmotion[i].path0) {
                    $('.img2').eq(num5).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonEmotion[i].path0 + jsonEmotion[i].savename0);
                } else {
                    $('.img2').eq(num5).css('display', 'none');
                }

                if (jsonEmotion[i].path1) {
                    $('.img1').eq(num5).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonEmotion[i].path1 + jsonEmotion[i].savename1);
                } else {
            ...
            if (need == 5 && off7) {
                ...
                if (jsonExperit[i].path0) {
                    $('.img2').eq(num6).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonExperit[i].path0 + jsonDevelop[i].savename0);
                } else {
                    $('.img2').eq(num6).css('display', 'none');
                }

                if (jsonExperit[i].path1) {
                    $('.img1').eq(num6).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonExperit[i].path1 + jsonDevelop[i].savename1);
                } else {
            ...
            if (need == 6 && off8) {
                ...
                if (jsonOther[i].path0) {
                    $('.img2').eq(num7).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonOther[i].path0 + jsonOther[i].savename0);
                } else {
                    $('.img2').eq(num7).css('display', 'none');
                }

                if (jsonOther[i].path1) {
                    $('.img1').eq(num7).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonOther[i].path1 + jsonOther[i].savename1);
                } else {
...
$('#need>li').click(function () {
    ...
    if (need == 0) {
        ...
        for (var _num2 = 1; _num2 < 6; _num2++) {
            ...
            if (message[i].path0) {
                $('.img2').eq(_num2).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + message[i].path0 + message[i].savename0);
            } else {
                $('.img2').eq(_num2).css('display', 'none');
            }

            if (message[i].path1) {
                $('.img1').eq(_num2).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + message[i].path1 + message[i].savename1);
            } else {
    ...
    if (need == 1) {
        ...
        for (; num < 6; num++) {
            ...
            if (jsonStudy[i].path0) {
                $('.img2').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonStudy[i].path0 + jsonStudy[i].savename0);
            } else {
                $('.img2').eq(num).css('display', 'none');
            }

            if (jsonStudy[i].path1) {
                $('.img1').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonStudy[i].path1 + jsonStudy[i].savename1);
            } else {
    ...
    if (need == 2) {
        ...
        for (; num < 6; num++) {
            ...
            if (jsonGroup[i].path0) {
                $('.img2').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonGroup[i].path0 + jsonGroup[i].savename0);
            } else {
                $('.img2').eq(num).css('display', 'none');
            }

            if (jsonGroup[i].path1) {
                $('.img1').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonGroup[i].path1 + jsonGroup[i].savename1);
            } else {
                $('.img1').eq(num).css('display', 'none');
            }
            $(".needData:last").on("click",pageInfo);
    ...
    if (need == 3) {
        ...
        for (; num < 6; num++) {
            ...
            if (jsonDevelop[i].path0) {
                $('.img2').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonDevelop[i].path0 + jsonDevelop[i].savename0);
            } else {
                $('.img2').eq(num).css('display', 'none');
            }

            if (jsonDevelop[i].path1) {
                $('.img1').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonDevelop[i].path1 + jsonDevelop[i].savename1);
            } else {
                $('.img1').eq(num).css('display', 'none');
            }
            $(".needData:last").on("click",pageInfo);
    ...
    if (need == 4) {
        ...
        for (; num < 6; num++) {
            ...
            if (jsonEmotion[i].path0) {
                $('.img2').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonEmotion[i].path0 + jsonEmotion[i].savename0);
            } else {
                $('.img2').eq(num).css('display', 'none');
            }

            if (jsonEmotion[i].path1) {
                $('.img1').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonEmotion[i].path1 + jsonEmotion[i].savename1);
            } else {
                $('.img1').eq(num).css('display', 'none');
            }
            $(".needData:last").on("click",pageInfo);
    ...
    if (need == 5) {
        ...
        for (; num < 6; num++) {
            ...
            if (jsonExperit[i].path0) {
                $('.img2').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonExperit[i].path0 + jsonExperit[i].savename0);
            } else {
                $('.img2').eq(num).css('display', 'none');
            }

            if (jsonExperit[i].path1) {
                $('.img1').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonExperit[i].path1 + jsonExperit[i].savename1);
            } else {
                $('.img1').eq(num).css('display', 'none');
            }
            $(".needData:last").on("click",pageInfo);
    ...
    if (need == 6) {
        ...
        for (; num < 6; num++) {
            ...
            if (jsonOther[i].path0) {
                $('.img2').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonOther[i].path0 + jsonOther[i].savename0);
            } else {
                $('.img2').eq(num).css('display', 'none');
            }

            if (jsonOther[i].path1) {
                $('.img1').eq(num).attr("src", "http://" + config_Address + "/coalball/Application/Common/Common/Uploads/" + jsonOther[i].path1 + jsonOther[i].savename1);
            } else {
                $('.img1').eq(num).css('display', 'none');
            }
              $(".needData:last").on("click",pageInfo);
